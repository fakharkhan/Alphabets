...
Titanium.Android.currentActivity.onCreateOptionsMenu = function(e) {
	...
	var menuAbout = menu.add({
		title : 'About'
	});
	menuAbout.setIcon('app://KS_nav_ui.png');
	menuAbout.addEventListener('click', function(e) {
		var winAbout =new Titanium.UI.createWindow({
	    ...
	    winAbout.add(webView);
	    winAbout.open({animated:true});
	});

	var menuSettings = menu.add({
		title : 'Settings'
	});
	menuSettings.setIcon('app://KS_nav_ui.png');
